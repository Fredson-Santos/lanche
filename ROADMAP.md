...
### 5.3 Deploy
- [ ] **Docker & DevOps**: Revisar o `docker-compose.yml` e o banco em nuvem (Ex: Render ou AWS RDS) para migrar o SQLite nativo de Dev para SQLite3 Production/Postgresql em deploy.
